...
tv watchlist get/add/remove/clear/sort/select
...
| `watchlist_get` / `watchlist_add` / `watchlist_remove` / `watchlist_clear` / `watchlist_sort` / `watchlist_select` | Read & manage watchlist (add, remove, clear with name guard, reorder, switch active list) |
...
- **Transport**: MCP over stdio (82 tools) + CLI (`tv` command, 30 commands with 70 subcommands)
