...
tv watchlist get/add/remove/clear/sort
...
| `watchlist_get` / `watchlist_add` / `watchlist_remove` / `watchlist_clear` / `watchlist_sort` | Read & manage watchlist (add, remove, clear with name guard, reorder) |
...
- **Transport**: MCP over stdio (81 tools) + CLI (`tv` command, 30 commands with 69 subcommands)
